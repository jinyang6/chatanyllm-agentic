...
- **Agentic Capabilities** - Edit files, process data (CSV, JSON, Charts), search content, and automate tasks within local workspaces.
...
- **Custom Providers** - Add any OpenAI-compatible API endpoint including local servers.
